...
@section('css')
<link rel="stylesheet" href="/dashbord/css/persian-datepicker-0.4.5.css">
@endsection
       ...
       <div class="pd-t-30">
               <div class="br-section-wrapper-level">
                   <div class="search-advance search-advance-vendor">
                       <button type="button" class="bg-teal-400 searchbtn searchbtn-store btn-icon btn-rounded"  data-toggle="tooltip" title="جستجو پیشرفته"><img src="/dashbord/images/search.svg" width="18"></button>
                           ...
                           <div class="rounded table-responsive">
                                <table class="table mg-b-0 table-tickets">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="">
                                                <img src="../dashbord/images/analytics.png" alt="">
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
...
@section('js-footer')
    ...
    <script src="/dashbord/js/persian-datepicker-0.4.5.js"></script>
    <script src="/dashbord/js/pwt-date.js"></script>
