...
@section('guide-categories-create') active @endsection
...
@section('content')
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a href="{{ route('dashboard.guide.categories.index') }}" class="breadcrumb-item">دسته بندی‌ها</a>
    ...
    <div class="pd-t-30">
        <div class="col-md-12">
            <div class="br-section-wrapper-level">
                ...
                {!! Form::open(['method' => 'POST', 'route' => 'dashboard.guide.categories.store']) !!}
                <div class="row">
                    <div class="col-xl-12">
